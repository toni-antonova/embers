...
TEMPLATES: dict[str, dict] = {
    "quadruped": {
        ...
        "nouns": [
            "horse", "dog", "cat", "cow", "lion", "tiger", "deer", "wolf",
            "bear", "elephant", "giraffe", "zebra", "fox", "rabbit", "pony",
            "stallion", "mare", "mustang", "puppy", "kitten", "leopard",
            "cheetah", "panther", "moose", "rhino", "hippo", "camel",
        ],
    },
    "biped": {
        "part_names": ["head", "torso", "left_arm", "right_arm", "left_leg", "right_leg"],
        "nouns": [
            "person", "human", "man", "woman", "child", "robot", "soldier",
            "dancer", "astronaut", "knight", "warrior", "zombie", "skeleton",
            "angel", "devil", "ninja", "samurai", "pirate",
        ],
    },
    "bird": {
        ...
        "nouns": [
            ...
            "crow", "raven", "dove", "sparrow", "hummingbird", "swan",
            "pelican", "toucan", "falcon", "vulture",
        ],
    },
    "fish": {
        "part_names": ["head", "body", "tail_fin", "dorsal_fin", "pectoral_fins"],
        "nouns": [
            "fish", "shark", "whale", "dolphin", "goldfish", "tuna",
            "swordfish", "ray", "seahorse", "octopus", "squid", "jellyfish",
        ],
    },
    "vehicle": {
        "part_names": ["body", "wheels", "windshield", "roof"],
        "nouns": [
            "car", "truck", "bus", "motorcycle", "van", "jeep", "taxi",
            "ambulance", "firetruck", "tractor",
        ],
    },
    "aircraft": {
        "part_names": ["fuselage", "left_wing", "right_wing", "tail", "engines"],
        "nouns": [
            "airplane", "jet", "helicopter", "plane", "biplane",
            "glider", "drone",
        ],
    },
    "furniture": {
        ...
        "nouns": [
            "chair", "stool", "bench", "throne", "couch", "sofa",
            "armchair", "recliner",
        ],
    },
    "plant": {
        ...
        "nouns": [
            "tree", "palm", "oak", "pine", "willow", "birch", "maple",
            "cactus", "bamboo", "bonsai",
        ],
    },
    "building": {
        "part_names": ["walls", "roof", "windows", "door", "foundation"],
        "nouns": [
            "house", "building", "castle", "church", "cabin", "temple",
            "tower", "lighthouse", "barn", "mosque", "cathedral",
        ],
    },
    "insect": {
        "part_names": ["head", "thorax", "abdomen", "wings", "legs"],
        "nouns": [
            "butterfly", "bee", "dragonfly", "beetle", "ant", "spider",
            "moth", "wasp", "grasshopper", "ladybug", "scorpion",
        ],
    },
    "default": {
        "part_names": ["body"],
